...
class BaseTradingEnvironment:
    ...
    def _get_normalized_observation(self):
        ...
        derived_features = {
            ...
            "bb_percent_b": ((price - lower_bb) / (upper_bb - lower_bb)) if (upper_bb - lower_bb) != 0 else 0,  # relative position in band
        }
        ...
        return np.concatenate([base_features_norm, derived_features_norm])
