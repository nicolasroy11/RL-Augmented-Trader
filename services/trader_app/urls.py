...
from services.trader_app.views.trader_views import TraderViews
...
schema_view = get_schema_view(
    openapi.Info(
        title="RL API",
        default_version='v1',
        description="<b>Endpoints for the Traders API</b>",
    ),
    public=True,
...
grids_method_list = inspect.getmembers(TraderViews, predicate=inspect.isfunction)
for i, method in grids_method_list:
    ...
    urlpatterns.append(path(TraderViews.url + method.path, view))