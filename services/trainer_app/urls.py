...
schema_view = get_schema_view(
    openapi.Info(
        title="RL API",
        default_version='v1',
        description="<b>Endpoints for the RL API</b>",
    ),
    public=True,
...
grids_method_list = inspect.getmembers(RLViews, predicate=inspect.isfunction)
for i, method in grids_method_list:
    ...
    urlpatterns.append(path(RLViews.url + method.path, view))